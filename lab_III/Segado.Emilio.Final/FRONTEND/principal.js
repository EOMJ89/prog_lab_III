...
$(document).ready(function () {
    ...
    userActual = JSON.parse(localStorage.getItem('userActual'));
...
(function (Principal) {
    var Manejador = /** @class */ (function () {
        ...
        Manejador.GuardarCambios = function () {
            ...
            var estiloFuente = $("input[name='rdoFuente']:checked").val();
            var opciones = {
                "fondo": colorFondo,
        ...
        Manejador.CambiarAspecto = function () {
            if (localStorage.getItem('op_' + userActual.correo) != null) {
                ...
                Principal.Manejador.SetearInputs(opciones_1);
                ...
                $('#tablaUsers').css({ 'color': opciones_1.colorfuente, 'background-color': opciones_1.fondo, 'font-size': (Principal.Manejador.ObtenerTamanio(opciones_1) + '%') });
            }
        };
