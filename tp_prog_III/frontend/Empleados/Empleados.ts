...
namespace Empleados {
    export class ManejadorEmpleados {
        public static Ingresar(): void {
            let token = Otras.ManejadoraOtros.GetToken();
            let datos: any = {
                "usuario": (<string>$('#usuarioText').val()),
                "clave": (<string>$('#passwordText').val()),
                "sector": (<string>$('#sectorText').val()),
                "perfil": (<string>$('#perfilText').val()),
            };
        ...
        private static ArmarLista(arr: any) {
            let listaString = '<!-- Default panel contents --><div class="panel panel-default"><div class="panel-heading">Listado de Empleados</div><!-- Table --><div class="table-responsive"><table class="table table-striped"><thead><th>ID</th><th>Usuario</th><th>Sector</th><th>Perfil</th><th>Estado</th>';
        ...
        public static Modificar(id: string) {
            $.ajax({
        ...
        private static ModificarForm(empleado: any) {
        ...
        private static ModificarEmpleado(id: number) {
            let token = Otras.ManejadoraOtros.GetToken();
            let datos: any = {
                "id": id,
                "usuario": (<string>$('#usuarioText').val()),
        ...
        public static Suspender(id: string, estado: string, usuario: string) {
            let mensaje = "Desea ";
        ...
        public static CantOperaciones() {
            let idEmp = ($('#idTextOperaciones').val() === '') ? 0 : parseInt(<string>$('#idTextOperaciones').val(), 10);
        ...
        public static MostrarOperaciones() {
            $.ajax({
        ...
        public static MostrarOperacionesSector() {
            $.ajax({
        ...
        public static MostrarOperacionesSectorEmpleado() {
            let sector = $('#idTextSector').val();
